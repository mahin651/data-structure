...
switch(ch)
{
case 1:cout<<"Enter the number of terms\n";
for(i=0;i<n;i++) {
cin>>c>>e;
create_poly1(c,e); }
break;
case 2: cout<<"Enter the number of terms\n";
cin>>n;
cout<<"Enter coefficient & power of each term\n";
for(i=0;i<n;i++) {
cin>>c>>e;
create_poly2(c,e); }
break;
...
case 4: add_poly();
break;
case 5:cout<<"Enter the value for x\n";
cin>>x;
eval_poly(x);
break;
case 6:return 0; }}}
...
void display() {
temp1=list1;
temp2=list2; temp3=list3;
cout<<"\nPOLYNOMIAL 1:";
while(temp1!=dummy1) {
cout<<temp1->coeff<<temp1->expo;
temp1=temp1
->ptr;
}
cout<<"\b ";
...
while(temp2!=dummy2) {
cout<<temp2->coeff<<temp2->expo;temp2=temp2->ptr;}
cout<<"\b ";
cout<<"\n\nSUM OF POLYNOMIALS:\n";
while(temp3
->ptr!=list3)
{
cout<<temp3->coeff,temp3->expo;
temp3=temp3->ptr;
}
cout<<temp3->coeff<<temp3->expo;
}
...
cout<<"Polynomial 1 Evaluation:"<<result;
result=0;
while(temp2!=dummy2) {
result+=(temp2
->coeff)*pow(x,temp2
...
cout<<"Polynomial 2 Evaluation:"<<result;
}
